...
function MenuItemsList({
  ...
  const baseItems = subCategoryName ? courseItems.filter((item) => item.subCategory === subCategoryName) : courseItems;
  const filtered = isSearching ? allItems.filter(
    (item) => item.name.toLowerCase().includes(trimmed.toLowerCase())
  ) : baseItems;
  const grouped = {};
  if (!isSearching) {
  ...
  const panelTitle = isSearching ? "Search Results" : subCategoryName ? subCategoryName : courseName || "Menu Items";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: containerRef,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-border bg-secondary/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-lg font-bold text-foreground mb-2", children: panelTitle }),
          ...
          showAddCustom && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          !isSearching && filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 h-[calc(100vh-320px)] min-h-[360px]", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-8 w-8 mb-2 opacity-30" }),
              isSearching ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs", children: "Press Enter or click the button above to add it as a custom item." })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Select a category from the left to browse items." })
            ]
          }
        ) : isSearching ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 flex flex-col gap-1.5", children: filtered.map((item, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `flex items-center gap-3 p-3 rounded-md transition-all border text-left w-full ${checked ? "bg-gold/10 border-gold/30" : "bg-card border-transparent hover:border-border hover:bg-secondary/50"}`,
              "data-ocid": `menu.item.${idx + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `w-4 h-4 rounded-sm border flex items-center justify-center shrink-0 text-[10px] ${checked ? "bg-gold border-gold text-white" : "border-gold/40"}`,
                    children: checked ? "✓" : ""
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `text-sm flex-1 ${checked ? "font-semibold text-foreground" : "text-muted-foreground"}`,
                    children: item.name
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground shrink-0", children: item.subCategory })
              ]
            },
            item.id
          );
        }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: Object.entries(grouped).map(([subCat, items]) => {
          const subIds = items.map((i) => i.id);
          const allSubSelected = subIds.every(
            (id) => selectedItems.has(id)
          );
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-bold text-gold uppercase tracking-wider border-b border-gold/20 pb-1 flex-1", children: subCat }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  children: allSubSelected ? "Deselect All" : "Select All"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1.5", children: items.map((item, idx) => {
              const checked = selectedItems.has(item.id);
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => onToggleItem(item.id),
                  className: `flex items-center gap-3 p-2.5 rounded-md transition-all border text-left w-full ${checked ? "bg-gold/10 border-gold/30" : "bg-card border-transparent hover:border-border hover:bg-secondary/50"}`,
                  "data-ocid": `menu.item.${idx + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
...
function MenuSidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gold px-4 py-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-white tracking-wide uppercase", children: "Menu Categories" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2", children: menuData2.map((course) => {
          const isOpen = selectedCourse === course.name;
          const courseSelectedCount = course.subCategories.flatMap((s) => s.items).filter((item) => selectedItems.has(item.id)).length;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `w-full rounded-md transition-colors text-left group border ${isOpen ? "bg-gold/10 border-gold/30" : "hover:bg-secondary border-transparent hover:border-gold/20"}`,
                "data-ocid": "menu.course.toggle",
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `font-serif text-sm font-semibold transition-colors ${isOpen ? "text-gold" : "text-foreground group-hover:text-gold"}`,
                      children: course.name
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    courseSelectedCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-gold text-white rounded-full w-5 h-5 flex items-center justify-center font-bold", children: courseSelectedCount }),
                    isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-3.5 w-3.5 text-gold" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-3.5 w-3.5 text-muted-foreground" })
                  ] })
                ] })
              }
            ),
            isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-2 border-l-2 border-gold/30 pl-2 mt-0.5 pb-1", children: course.subCategories.map((sub) => {
              const subCount = sub.items.filter(
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `w-full flex items-center justify-between px-3 py-1.5 rounded-md text-xs transition-colors text-left ${isSubSelected ? "bg-gold/20 text-gold font-semibold" : "text-muted-foreground hover:bg-secondary hover:text-foreground"}`,
                  "data-ocid": "menu.subcategory.toggle",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: sub.name }),
                    subCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-gold/20 text-gold rounded-full px-1.5 font-semibold", children: subCount })
                  ]
                },
                sub.name
              );
...
function SelectedPanel({
  ...
  function handleGenerate() {
    if (selectedItems.length === 0) {
      ue.error("Please select at least one menu item.");
      return;
    }
    onGeneratePdf();
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gold px-4 py-3 flex items-center justify-between shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-white tracking-wide uppercase", children: "Selected Items" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-white/20 text-white rounded-full px-2 py-0.5 font-bold", children: selectedItems.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-b border-border space-y-2 bg-secondary/30 shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 overflow-auto", children: selectedItems.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl mb-2", children: "✦" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No items selected yet." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Click items from the menu to add them." })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 space-y-3", children: Object.entries(groups).map(([subCat, items]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-gold uppercase tracking-wider mb-1.5", children: subCat }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground flex-1 truncate", children: item.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "mt-2" })
        ] }, subCat)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-2 border-t border-border bg-secondary/20 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-muted-foreground", children: "A print dialog will open. Save as PDF." })
        ] })
      ]
    }
  );
}
function makeItems(course, sub, names) {
...
function buildPrintHtml(selectedItems, eventName, eventDate) {
  const grouped = {};
  for (const item of selectedItems) {
  ...
  const formattedDate = eventDate ? (/* @__PURE__ */ new Date(`${eventDate}T00:00:00`)).toLocaleDateString("en-IN", {
    day: "2-digit",
    month: "long",
    year: "numeric"
  }) : "";
  const coursesHtml = Object.entries(grouped).map(
    ([course, subCats]) => `
  ...
  const eventInfoHtml = eventName || formattedDate ? `<div class="event-info">&mdash;&nbsp;${eventName}${eventName && formattedDate ? "&nbsp;&nbsp;|&nbsp;&nbsp;" : ""}${formattedDate}&nbsp;&mdash;</div>` : "";
...
function App() {
  const [selectedCourse, setSelectedCourse] = reactExports.useState(
    () => {
      var _a2;
      return ((_a2 = menuData[0]) == null ? void 0 : _a2.name) ?? null;
    }
  );
  const [selectedSubCategory, setSelectedSubCategory] = reactExports.useState(
    null
  );
  ...
  const allMenuItems = menuData.flatMap(
  ...
  function handleSelectSubCategory(subName) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-navy text-white sticky top-0 z-50 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-xl font-bold text-gold leading-tight", children: "Vijay Caterers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gold-light opacity-80", children: "Premium Catering Services" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-6 text-sm font-medium", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-semibold", children: "Menu Generator" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://vijay-caterers.onrender.com",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-b from-[oklch(0.16_0.03_250)] to-[oklch(0.22_0.03_250)] py-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold text-3xl mb-2", children: "✦" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-4xl font-bold text-gold mb-2", children: "Design Your Custom Branded Menu PDF" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold-light opacity-70 text-sm", children: "Search items · Add to menu · Download as PDF" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-7xl mx-auto w-full px-4 py-6 grid grid-cols-1 md:grid-cols-[260px_1fr_300px] gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MenuSidebar,
        {
          menuData,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-navy text-center py-6 mt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-serif", children: "Contact: 9866937747, 9959500833  |  Instagram: @vijaycaterers_" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gold-light opacity-50 text-xs mt-2", children: [
        "© ",
